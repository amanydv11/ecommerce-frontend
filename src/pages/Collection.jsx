  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border'>
      ...
      <div className="min-w-60">
        ...
        {/** Category filter */}
        <div className={`border rounded-r border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' :'hidden' } sm:block`}>
        ...
        {/** subcategory filter */}
        <div className={`border rounded-r border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' :'hidden' } sm:block`}>
...
<div className="flex-1">
  ...
  {/**PRODUCT SHORt */}
  <select onChange={(e)=>setSortType(e.target.value)} className='border rounded-l border-gray-300 text-sm px-2' >
